...
namespace food_webapp_dotnet.Migrations
{
    ...
    [Migration("20241020060553_Initial Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("food_webapp_dotnet.Models.Dish", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("food_webapp_dotnet.Models.Ingredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("food_webapp_dotnet.Models.DishIngredient", b =>
                {
                    b.HasOne("food_webapp_dotnet.Models.Dish", "Dish")
                        .WithMany("DishIngredients")
                        .HasForeignKey("DishId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("food_webapp_dotnet.Models.Ingredient", "Ingredient")
                        .WithMany("DishIngredients")
